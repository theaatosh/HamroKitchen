                ...
                <div className={styles.greeting_con}>
                    {isKitchenOnline?(
                        <div className={styles.greeting}>
                            ...
                            Welcome, Rider <span className={styles.chef_name}>{(profileData?.userName)?.toUpperCase() || "Kitchen User"} </span> </p>
                    <p>Ready to deliver </p>
                        </div>):( <div className={styles.greeting}>
                            <p className={styles.greeting_text}>
                    Welcome, Rider <span className={styles.chef_name}>{(profileData?.userName)?.toUpperCase() || "Kitchen User"}</span>
                    </p>
